...
#include"acllib.h"
#include"math.h"
RectangleClock::RectangleClock(int x, int y, int w, int h) :Clock(), Shape(x, y, w, h)
{

}
RectangleClock::RectangleClock(int z, int h, int m, int s, int x, int y, int width, int height) : Clock(z, h, m, s), Shape(x, y, width, height)
{
